...
#define CYGPKG_HAL_FRV current
#define CYGPKG_HAL_FRV_current
#define CYGNUM_HAL_FRV_VERSION_MAJOR CYGNUM_VERSION_CURRENT
#define CYGNUM_HAL_FRV_VERSION_MINOR -1
#define CYGNUM_HAL_FRV_VERSION_RELEASE -1
#define CYGPKG_HAL_FRV_FRV400 current
#define CYGPKG_HAL_FRV_FRV400_current
#define CYGNUM_HAL_FRV_FRV400_VERSION_MAJOR CYGNUM_VERSION_CURRENT
#define CYGNUM_HAL_FRV_FRV400_VERSION_MINOR -1
...
#define CYGHWR_MEMORY_LAYOUT_LDI <pkgconf/mlt_frv_frv400_ram.ldi>
#define CYGHWR_MEMORY_LAYOUT_H <pkgconf/mlt_frv_frv400_ram.h>
